            ...
            <div className="py-8 px-3">
                ...
                <div className="flex flex-col items-center sm:items-start">
                    <div className="bg-white w-full  p-2  mb-3">
                        <h6 className={error ? 'text-red-600' : 'text-secondary'}>Email</h6>
                        <input type="email" onChange={handleInputChange} name="email" 
                        className={`bg-white ${error ? 'border-red-700 shadow-red-900' : 'border-secondary'} border rounded p-3 w-full text-sm flex-1 pr-10 `}
                    />

                    </div>
                    <div className="bg-white w-full  text-sm p-2 mb-1 relative">
                        <h6 className={error ? 'text-red-600' : 'text-secondary'}>Password</h6>
                        <div className="relative">
                            <input
                                type={visible ? "text" : "password"}
                                onChange={handleInputChange}
                                name="password"
                                className={`bg-white ${error ? 'border-red-700' : 'border-secondary'} border rounded p-3 w-full text-sm flex-1 pr-10 `}
                    ...
                    <button onClick={handleLogin} type="button" class="text-white sm:w-full  bg-[#035fb2] hover:bg-[#0360b2f1] focus:outline-none focus:ring-4 focus:ring-blue-300 font-normal rounded-full text-sm px-20 py-2.5 text-center me-2 mb-2 ">Login</button>
                </div>
            </div>
        </div>
